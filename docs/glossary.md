...
- **OKF (Open Knowledge Format)** — spec aberta (v0.1) para conhecimento consumível por agentes e humanos: um bundle (diretório de arquivos `.md` com frontmatter YAML) com `index.md`, `log.md` e conceitos. Único campo obrigatório: `type`. <https://okf.md/>. Projeto: `docs/knowledge/`. (ADR-0006)
